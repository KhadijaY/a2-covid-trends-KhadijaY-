...
counties<- counties %>%
  unite(location, county, state, sep=", ", remove = FALSE, na.rm = T)
...
#what is the median number of cases in the county? 
    med_cases_county<-median(county$cases)
 # what is the median number of cases in US states? 
    median_cases_states<- median(states$cases)
 # What is the median number of cases using the national dataset? 
    median_cases_national<-median(national$cases)
